...
# We need to replace the entire generate_json_response function body
# I will use a regex to match from "def generate_json_response" to "def get_call_stats"

new_func = """    def generate_json_response(self, system_prompt: str, user_prompt: str) -> Dict[str, Any]:
        \"\"\"
        ...
        if not primary_configs:
            ...
            return {"error": "PROVIDER_UNAVAILABLE", "status": "FAILED", "message": "Primary NVIDIA provider not configured."}
